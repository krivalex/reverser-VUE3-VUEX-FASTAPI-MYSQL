...
export default {
  ...
  data: () => ({
    ...
    options: [
      ...
      { id: 1, icon: "fa fa-info", title: "Обо мне", path: { name: "client" } },
      { id: 2, icon: "fa fa-heart", title: "Избранное", path: { name: 'client_favourites' } },
      { id: 3, icon: "fa fa-comments", title: "Мои отзывы", path: { name: 'client_reviews' } },
    ],
  }),
};
</script>
